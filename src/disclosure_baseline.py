...
HEARTBEAT_HEALTH_KEYS: tuple[str, ...] = (
    ...
    # timezone the heartbeat already carries, and no activity data. Declared
    # because a drifted anchor silently zeroes an employee's whole day
    # ("Outside working hours", 0h 0m) with nothing on any surface explaining
    # why, and the fix needs the fleet to be able to see it.
